...
var button1 = document.querySelector("#button1"); // speichert den boobutton
var button2 = document.querySelector("#button2"); // speichert den laughbutton
var button3 = document.querySelector("#button3"); // speichert den duckbutton
var button4 = document.querySelector("#button4"); // speichert den boingbutton
var button5 = document.querySelector("#button5"); // speichert den applausebutton
...
var soundButtons = [button1, button2, button3, button4, button5];
...
//# sourceMappingURL=scriptenda.js.map