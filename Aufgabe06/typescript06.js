window.addEventListener('load', function () {
    ...
    function EuropeFunction() {
        ...
        document.querySelector(".chartWrapper .chart").setAttribute("style", "height:16.8%");
    }
    function NorthamericaFunction() {
        ...
        document.querySelector(".chartWrapper .chart").setAttribute("style", "height:21.1%");
    }
    function SouthamericaFunction() {
        ...
        document.querySelector(".chartWrapper .chart").setAttribute("style", "height:4.7%");
    }
    function AfricaFunction() {
        ...
        document.querySelector(".chartWrapper .chart").setAttribute("style", "height:3.5%");
    }
    function AsiaFunction() {
        ...
        document.querySelector(".chartWrapper .chart").setAttribute("style", "height:46.3%");
    }
    function AustraliaFunction() {
        ...
        document.querySelector(".chartWrapper .chart").setAttribute("style", "height:7.6%");
    }
});
